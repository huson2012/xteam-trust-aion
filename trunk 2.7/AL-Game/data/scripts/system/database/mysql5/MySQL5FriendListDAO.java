...
import com.light.gameserver.model.gameobjects.player.FriendList;
...
public class MySQL5FriendListDAO extends FriendListDAO {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.light.gameserver.dao.FriendListDAO#load(com.light.gameserver.model.gameobjects.player.Player)
	 */
	@Override
