...
public class MySQL5PlayerQuestListDAO extends PlayerQuestListDAO {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.light.gameserver.dao.PlayerQuestListDAO#load(com.light.gameserver.model.gameobjects.player.Player)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.light.gameserver.dao.PlayerQuestListDAO#store(com.light.gameserver.model.gameobjects.player.Player)
	 */
	@Override
