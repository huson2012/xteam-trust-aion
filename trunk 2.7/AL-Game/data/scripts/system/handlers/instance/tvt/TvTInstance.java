...
import com.light.gameserver.model.instance.instancereward.TvtReward;
...
import com.light.gameserver.services.SystemMailService;
...
import com.light.gameserver.services.tvt.TvtBossTemplate;
import com.light.gameserver.services.tvt.TvtRegistrator;
...
//import com.light.gameserver.utils.i18n.CustomMessageIdRU;
//import com.light.gameserver.utils.i18n.LanguageHandler;
...
public class TvTInstance extends GeneralInstanceHandler {
    ...
    {
        for (com.light.gameserver.skillengine.model.Effect ef : player.getEffectController().getAbnormalEffects()) {
				if (ef.isAvatar()) {
					ef.endEffect();
