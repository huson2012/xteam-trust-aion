...
import com.light.gameserver.model.templates.walker.WalkerTemplate;
import com.light.gameserver.network.aion.serverpackets.SM_DELETE;
import com.light.gameserver.network.aion.serverpackets.SM_NPC_INFO;
...
public class SpawnUpdate extends ChatCommand {
	...
	public void execute(Player admin, String... params) {
	    ...
	    if (params.length != 1) {
		    PacketSendUtility.sendMessage(admin, "<usage //spawnu set (x | y | z | h | w | xyz)");
			return;
		}
