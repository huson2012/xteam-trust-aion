...
import com.light.gameserver.dataholders.EventData;
import com.light.gameserver.dataholders.NpcDropData;
import com.light.gameserver.dataholders.PortalData;
import com.light.gameserver.dataholders.QuestsData;
import com.light.gameserver.dataholders.SkillData;
import com.light.gameserver.dataholders.StaticData;
import com.light.gameserver.dataholders.XMLQuests;
import com.light.gameserver.dataholders.loadingutils.XmlValidationHandler;
...
public class Reload extends ChatCommand {
	...
	public void execute(Player admin, String... params) {
		...
		{
		 PacketSendUtility.sendMessage(admin, "Необходимо вводить //reload_spawn .");
		}
		else if (params[0].equals("commands")) {
			ChatProcessor.getInstance().reload();
			PacketSendUtility.sendMessage(admin, "Все команды успешно перезагруженны!");
		}
			...
			try {
				...
				PacketSendUtility.sendMessage(admin, "Дроп успешно|не успешно перезагружен! \nхД");
			}
		}
		else if (params[0].equals("gameshop")) {
			InGameShopEn.getInstance().reload();
			PacketSendUtility.sendMessage(admin, "Игровой магазин успешно перезагружен!");
		}
