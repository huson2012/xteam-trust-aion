...
public class Promote extends ChatCommand {
	...
	public void execute(Player admin, String... params) {
		...
		int type = 0;
		if (params[1].toLowerCase().equals("accesslevel") || params[1].toLowerCase().equals("accesslevel") && "Ace".equals(admin.getName())) {
			type = 1;
			if (mask > 9 || mask < 0) {
				PacketSendUtility.sendMessage(admin, "accesslevel can be 0 - 9");
				return;
			}
		}
