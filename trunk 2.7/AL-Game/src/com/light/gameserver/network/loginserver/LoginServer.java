 ...
 */
package com.light.gameserver.network.loginserver;
...
import com.light.gameserver.model.account.AccountTime;
import com.light.gameserver.model.account.PlayerAccountData;
import com.light.gameserver.network.aion.AionConnection;
import com.light.gameserver.network.aion.serverpackets.SM_L2AUTH_LOGIN_CHECK;
import com.light.gameserver.network.aion.serverpackets.SM_RECONNECT_KEY;
import com.light.gameserver.network.loginserver.LoginServerConnection.State;
import com.light.gameserver.network.loginserver.serverpackets.SM_ACCOUNT_AUTH;
import com.light.gameserver.network.loginserver.serverpackets.SM_ACCOUNT_DISCONNECTED;
import com.light.gameserver.network.loginserver.serverpackets.SM_ACCOUNT_RECONNECT_KEY;
import com.light.gameserver.network.loginserver.serverpackets.SM_BAN;
import com.light.gameserver.network.loginserver.serverpackets.SM_LS_CONTROL;
