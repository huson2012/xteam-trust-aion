...
import com.light.gameserver.controllers.RiftController;
...
public class SM_RIFT_ANNOUNCE extends AionServerPacket {
	...
	public SM_RIFT_ANNOUNCE(int action, int targetObjectId, RiftEnum rifts, SpawnTemplate spawnTemplate, int time) {
        this.action = action;
