...
public class Account implements Iterable<PlayerAccountData> {
	...
	public ArrayList<PlayerAccountData> getSortedAccountsList() {
        ...
        public ArrayList<PlayerAccountData> getSortedAccountsList2() {
		ArrayList<PlayerAccountData> list = new ArrayList<PlayerAccountData>();
		list.addAll(players.values());
		Collections.sort(list, new Comparator<PlayerAccountData>() {
			...
			@Override
			public int compare(PlayerAccountData x, PlayerAccountData y) {
				Timestamp t1 = x.getPlayerCommonData().getCreationDate();
				Timestamp t2 = y.getPlayerCommonData().getCreationDate();
				if (t2 == null)
					return 1;
				else if (t1 == null)
					return -1;
				return y.getPlayerCommonData().getCreationDate().compareTo(x.getPlayerCommonData().getCreationDate());
			}
		});
		return list;
	}
