...
import light.dao.MySQL5AccountDAO;
...
import com.light.gameserver.controllers.FlyController;
...
import com.light.gameserver.controllers.attack.PlayerAggroList;
import com.light.gameserver.controllers.effect.PlayerEffectController;
import com.light.gameserver.controllers.movement.PlayerMoveController;
import com.light.gameserver.dao.PlayerVarsDAO;
...
import com.light.gameserver.model.gameobjects.player.AbyssRank.AbyssRankUpdateType;
...
import com.light.gameserver.model.items.ItemCooldown;
import com.light.gameserver.model.items.storage.IStorage;
import com.light.gameserver.model.items.storage.LegionStorageProxy;
...
import com.light.gameserver.model.team.legion.LegionMember;
import com.light.gameserver.model.team2.TeamMember;
import com.light.gameserver.model.team2.TemporaryPlayerTeam;
...
import com.light.gameserver.model.templates.BoundRadius;
...
import com.light.gameserver.model.templates.npc.AbyssNpcType;
...
import com.light.gameserver.skillengine.effect.EffectTemplate;
import com.light.gameserver.skillengine.effect.RebirthEffect;
import com.light.gameserver.skillengine.model.Effect;
import com.light.gameserver.skillengine.model.SkillTemplate;
import com.light.gameserver.skillengine.task.CraftingTask;
import com.light.gameserver.utils.PacketSendUtility;
import com.light.gameserver.utils.rates.Rates;
import com.light.gameserver.utils.rates.RegularRates;
...
public class Player extends Creature {
	...
	private com.light.gameserver.model.team2.group.PlayerGroup playerGroup2;
    ...
    public int getDonatmoney() {
		return MySQL5AccountDAO.getInstance().getDonateMoney(getPlayerAccount().getId());
	}
    
    public void setDonatmoney(int count) {
    	MySQL5AccountDAO.getInstance().updateDonatemoney(getPlayerAccount().getId(), count);
    }
    
    public void addDonatmoney(int count) {
    	setDonatmoney(getDonatmoney() + count);
    }
	...
	public com.light.gameserver.model.team2.group.PlayerGroup getPlayerGroup2() {
		return playerGroup2;
	}

	public void setPlayerGroup2(com.light.gameserver.model.team2.group.PlayerGroup playerGroup) {
	...
	public com.light.gameserver.model.team2.alliance.PlayerAlliance getPlayerAlliance2() {
	...
	public boolean haveSelfRezEffect() {
		if (getAccessLevel() >= AdminConfig.ADMIN_AUTO_RES || getWorldId() == AdminConfig.LOC_ID)
			return true;
    ...
    public void setTeleportTask(TeleportTask teleport)
    {
        this.teleportTask = teleport;
    }
