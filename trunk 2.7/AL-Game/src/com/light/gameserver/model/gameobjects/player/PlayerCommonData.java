...
import com.light.gameserver.network.aion.serverpackets.SM_DP_INFO;
import com.light.gameserver.network.aion.serverpackets.SM_STATUPDATE_DP;
import com.light.gameserver.network.aion.serverpackets.SM_STATUPDATE_EXP;
import com.light.gameserver.network.aion.serverpackets.SM_SYSTEM_MESSAGE;
import com.light.gameserver.utils.PacketSendUtility;
import com.light.gameserver.utils.stats.XPLossEnum;
...
public class PlayerCommonData extends VisibleObjectTemplate {
   ...
   public void addExp(long value) {
	...
	public void setRace(Race race) {
        ...
        public void setDonatmoney(int donatmoney) {
	  this.donatmoney = donatmoney;
	}
	...
	public void setDp(int dp) {
		if (getPlayer() != null) {
			if (playerClass.isStartingClass() || getPlayer().isInvul())
				return;
