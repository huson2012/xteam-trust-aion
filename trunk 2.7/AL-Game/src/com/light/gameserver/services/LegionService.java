...
import com.light.gameserver.dao.LegionDAO;
import com.light.gameserver.dao.LegionMemberDAO;
...
import com.light.gameserver.model.team.legion.LegionEmblemType;
import com.light.gameserver.model.team.legion.LegionHistory;
import com.light.gameserver.model.team.legion.LegionHistoryType;
import com.light.gameserver.model.team.legion.LegionMember;
import com.light.gameserver.model.team.legion.LegionMemberEx;
import com.light.gameserver.model.team.legion.LegionPermissionsMask;
import com.light.gameserver.model.team.legion.LegionRank;
import com.light.gameserver.network.aion.serverpackets.SM_DIALOG_WINDOW;
import com.light.gameserver.network.aion.serverpackets.SM_LEGION_ADD_MEMBER;
import com.light.gameserver.network.aion.serverpackets.SM_LEGION_EDIT;
import com.light.gameserver.network.aion.serverpackets.SM_LEGION_INFO;
import com.light.gameserver.network.aion.serverpackets.SM_LEGION_LEAVE_MEMBER;
import com.light.gameserver.network.aion.serverpackets.SM_LEGION_MEMBERLIST;
import com.light.gameserver.network.aion.serverpackets.SM_LEGION_SEND_EMBLEM;
import com.light.gameserver.network.aion.serverpackets.SM_LEGION_SEND_EMBLEM_DATA;
import com.light.gameserver.network.aion.serverpackets.SM_LEGION_TABS;
import com.light.gameserver.network.aion.serverpackets.SM_LEGION_UPDATE_EMBLEM;
import com.light.gameserver.network.aion.serverpackets.SM_LEGION_UPDATE_MEMBER;
import com.light.gameserver.network.aion.serverpackets.SM_LEGION_UPDATE_NICKNAME;
import com.light.gameserver.network.aion.serverpackets.SM_LEGION_UPDATE_SELF_INTRO;
import com.light.gameserver.network.aion.serverpackets.SM_LEGION_UPDATE_TITLE;
...
import com.light.gameserver.world.container.LegionContainer;
import com.light.gameserver.world.container.LegionMemberContainer;
		...
		switch (exOpcode) {
			...
			case 0x01:
				if (targetPlayer != null) {
					if (targetPlayer.getPlayerSettings().isInDeniedStatus(DeniedStatus.GUILD) && !activePlayer.isGM()) {
