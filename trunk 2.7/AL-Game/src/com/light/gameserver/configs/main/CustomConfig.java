 ...
 */
package com.light.gameserver.configs.main;
...
public class CustomConfig {
	...
	@Property(key = "gameserver.command.add.restricted.items", defaultValue = "0")
	public static String ADD_RESTRICTED_ITEMS;
