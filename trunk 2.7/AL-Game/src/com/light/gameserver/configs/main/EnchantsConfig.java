...
public class EnchantsConfig {
	 ...
	 * ManaStone Time Use
	 */
        @Property(key = "gameserver.base.manastone.time", defaultValue = "100")
	public static long MANA_STONE_TIME;
        @Property(key = "gameserver.base.enchant.time", defaultValue = "100")
