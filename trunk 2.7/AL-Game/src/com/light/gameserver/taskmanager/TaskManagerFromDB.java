...
package com.light.gameserver.taskmanager;
...
import com.light.gameserver.dao.TaskFromDBDAO;
import com.light.gameserver.model.tasks.TaskFromDB;
import com.light.gameserver.model.templates.tasks.TaskFromDBHandler;
import com.light.gameserver.taskmanager.tasks.RestartTask;
import com.light.gameserver.taskmanager.tasks.ShutdownTask;
...
public class TaskManagerFromDB {
	...
	/**
	 * Retuns {@link com.light.gameserver.dao.TaskFromDBDAO} , just a shortcut
	 * 
	 * @return {@link com.light.gameserver.dao.TaskFromDBDAO}
	 */
