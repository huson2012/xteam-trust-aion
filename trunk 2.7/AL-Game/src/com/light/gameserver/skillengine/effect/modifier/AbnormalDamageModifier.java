 ...
 */
package com.light.gameserver.skillengine.effect.modifier;
...
public class AbnormalDamageModifier extends ActionModifier {
	...
	/* (non-Javadoc)
	 * @see com.light.gameserver.skillengine.effect.modifier.ActionModifier#analyze(com.light.gameserver.skillengine.model.Effect)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.light.gameserver.skillengine.effect.modifier.ActionModifier#check(com.light.gameserver.skillengine.model.Effect)
	 */
	@Override
