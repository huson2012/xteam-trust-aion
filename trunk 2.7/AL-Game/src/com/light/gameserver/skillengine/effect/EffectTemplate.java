...
import com.light.gameserver.model.SkillElement;
...
import com.light.gameserver.skillengine.change.Change;
import com.light.gameserver.skillengine.condition.Conditions;
import com.light.gameserver.skillengine.effect.modifier.ActionModifier;
import com.light.gameserver.skillengine.effect.modifier.ActionModifiers;
import com.light.gameserver.skillengine.model.Effect;
import com.light.gameserver.skillengine.model.HitType;
import com.light.gameserver.skillengine.model.HopType;
...
public abstract class EffectTemplate {
	...
	void afterUnmarshal(Unmarshaller u, Object parent) {
		...
		try {
			temp = EffectType.valueOf(this.getClass().getName().replaceAll("com.light.gameserver.skillengine.effect.", "").replaceAll("Effect", "").toUpperCase());
		} catch (Exception e) {
			log.info("missing effectype for "+this.getClass().getName().replaceAll("com.light.gameserver.skillengine.effect.", "").replaceAll("Effect", "").toUpperCase());
		}
