...
import com.light.gameserver.network.aion.serverpackets.SM_CASTSPELL;
import com.light.gameserver.network.aion.serverpackets.SM_CASTSPELL_RESULT;
...
import com.light.gameserver.services.MotionLoggingService;
...
import com.light.gameserver.skillengine.action.Action;
import com.light.gameserver.skillengine.action.Actions;
import com.light.gameserver.skillengine.condition.Conditions;
import com.light.gameserver.skillengine.condition.TargetAttribute;
import com.light.gameserver.skillengine.effect.AbnormalState;
import com.light.gameserver.skillengine.properties.FirstTargetAttribute;
import com.light.gameserver.skillengine.properties.Properties;
import com.light.gameserver.skillengine.properties.TargetRangeAttribute;
	...
	protected void calculateSkillDuration() {
		...
		switch (skillTemplate.getSubType()) {
			...
			case HEAL:
				...
				break;
			case ATTACK:
				if (skillTemplate.getType() == com.light.gameserver.skillengine.model.SkillType.MAGICAL) {
