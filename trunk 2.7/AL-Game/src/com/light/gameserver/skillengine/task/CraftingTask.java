 ...
 */
package com.light.gameserver.skillengine.task;

import com.aionemu.commons.utils.Rnd;
import com.light.gameserver.configs.main.CraftConfig;
...
import com.light.gameserver.model.templates.recipe.RecipeTemplate;
import com.light.gameserver.network.aion.serverpackets.SM_CRAFT_ANIMATION;
import com.light.gameserver.network.aion.serverpackets.SM_CRAFT_UPDATE;
import com.light.gameserver.services.CraftService;
...
public class CraftingTask extends AbstractCraftTask {
	...
	/*
	 * (non-Javadoc)
	 * @see com.light.gameserver.skillengine.task.AbstractCraftTask#onFailureFinish()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.light.gameserver.skillengine.task.AbstractCraftTask#onSuccessFinish()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.light.gameserver.skillengine.task.AbstractCraftTask#sendInteractionUpdate()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.light.gameserver.skillengine.task.AbstractInteractionTask#onInteractionAbort()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.light.gameserver.skillengine.task.AbstractInteractionTask#onInteractionFinish()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.light.gameserver.skillengine.task.AbstractInteractionTask#onInteractionStart()
	 */
	@Override
