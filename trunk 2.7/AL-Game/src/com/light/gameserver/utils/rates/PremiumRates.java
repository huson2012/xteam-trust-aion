 ...
 */
package com.light.gameserver.utils.rates;
...
public class PremiumRates extends Rates {
	...
	/*
	 * (non-Javadoc)
	 * @see com.light.gameserver.utils.rates.Rates#getCraftingXPRate()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.light.gameserver.utils.rates.Rates#getGatheringXPRate()
	 */
	@Override
