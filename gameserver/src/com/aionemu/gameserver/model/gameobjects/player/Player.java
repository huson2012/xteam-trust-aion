...
public class Player extends Creature
{
	...
	private Future<?> playerUpdateTask;
	private Future<?> playerItemUpdateTask;
	...
	{
		playerUpdateTask = ThreadPoolManager.getInstance().scheduleAtFixedRate(
			new GeneralUpdateTask(this), PeriodicSaveConfig.PLAYER_GENERAL * 1000, PeriodicSaveConfig.PLAYER_GENERAL * 1000);
		playerItemUpdateTask = ThreadPoolManager.getInstance().scheduleAtFixedRate(
